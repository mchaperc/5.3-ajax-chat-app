...
this["JST"]["chat"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"container-channels\">\n	<ul class=\"list-of-channels\">\n		\n	</ul>\n</div>\n<div class=\"container-content\">\n	<div class=\"messages-container\">\n		\n	</div>\n	<div class=\"message-input\">\n		<form action=\"\" class=\"message-input-form\">\n			<button class=\"submit\"><i class=\"fa fa-arrow-circle-o-up\"></i></button>\n			<input type=\"text\" class=\"message-input-content\" autofocus>\n		</form>\n	</div>\n</div>";
},"useData":true});
...
this["JST"]["messages"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<ul class=\"list-of-messages\">\n"
    + ((stack1 = helpers.each.call(depth0,depth0,{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "</ul>";
},"useData":true});
this["JST"]["users"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var helper;
